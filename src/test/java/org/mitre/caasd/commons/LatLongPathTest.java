...
class LatLongPathTest {
    ...
    public void pathDist() {
        ...
        LatLongPath path = LatLongPath.from(
                LatLong.of(0.0, 0.1), LatLong.of(1.0, 1.1), LatLong.of(2.0, 2.1), LatLong.of(3.0, 3.1));
    ...
    public void legIteratorHasNothingWhenSmallPath() {
        ...
        LatLongPath path = LatLongPath.from(LatLong.of(0.0, 0.1));
    ...
    public void testJoiningMultiplePaths_varArgs() {
        ...
        LatLongPath path1 = LatLongPath.from(LatLong.of(0.0, 0.1), LatLong.of(1.0, 1.1), LatLong.of(2.0, 2.1));

        LatLongPath path2 = LatLongPath.from(LatLong.of(3.0, 3.1), LatLong.of(4.0, 4.1));

        LatLongPath path3 = LatLongPath.from(LatLong.of(5.0, 5.1));
